...
| [3047. Find the Largest Area of Square Inside Two Rectangles](./LargestSquareTwoRectangles.java) | LeetCode | Medium | check all pairs via brute force then see if they intersect and then see what is maximum size square obtainable |
