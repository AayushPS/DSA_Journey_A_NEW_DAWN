...
|-------|-------------|----------------|
| [📊 Arrays](./Arrays) | Fundamental array operations and algorithms | 11 |
...
| [💡 Dynamic Programming](./DynamicProgramming) | Optimization using overlapping subproblems | 13 |
...
### Recent Activity
- 🎯 **Thirteenth Dynamic Programming Problem on Longest Palindromic Substring** - November 19, 2025
