...
| [1975. Maximum Matrix Sum](./MaximumMatrixSum.java) | LeetCode | Medium | Only 1 element in entire matrix can be negative at max |
| [1877. Minimize Maximum Pair Sum in Array](./MinimizeMaximumPairSum.java) | LeetCode | Medium | sort then pair first with last and so on |
